...
export const PrivacyPolicy = () => {
    return (
        ...
        <div data-custom-class="body" style={{padding: '1rem'}}>
        <div>
          <strong>
            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">August 12, 2022</bdt>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                <bdt className="question">Future Protocol Co</bdt>
                ...
                <span style={{ color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    <bdt className="question">Websan)</bdt>
            ...
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">
                    <a
                      href="http://www.joinwebsan.xyz"
                      target="_blank"
                      data-custom-class="link"
                    >
                      http://www.joinwebsan.xyz
                    </a>
                  </bdt>
                  <span style={{ fontSize: 15 }}>
                    <span style={{ color: "rgb(89, 89, 89)" }}>
        ...
        <div>
            ...
            <span style={{ fontSize: 15 }}>
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span data-custom-class="body_text">
                  ...
                  contact us at <bdt className="question">hello@web3talents.co </bdt>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            <a
              data-custom-class="link"
              href="https://app.termly.io/notify/98e5b043-6cc1-4cc3-9418-30278f3e9638"
                                              ...
                                              <li style={{ lineHeight: "1.5" }}>
                                                <span style={{ fontSize: 15 }}>
                                                  <span data-custom-class="body_text">
                                                    ...
                                                    areas of the Services, such
                                                    personal information may be viewed
                                                    by all users and may be publicly
                                                    ...
                                                    will see your name, profile photo,
                                                ...
                                                >
                                                  ...
                                                  >
                                                    <span data-custom-class="body_text">
                                                      ...
                                                      time by contacting us by using
                                              ...
                                              <div style={{ lineHeight: "1.5" }}>
                                                ...
                                                <span style={{ fontSize: 15 }}>
                                                  <span data-custom-class="body_text">
                                                    ...
                                                    and use of your account, to
                                                    respond to service requests, or
                                                ...
                                                >
                                                  ...
                                                  >
                                                    <span data-custom-class="body_text">
                                                      ...
                                                      services of our Services. To opt
